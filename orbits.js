...
{
    console.log("displayCalendar has started");
    var date;
...
function selectDate(event)
{
    ...
    console.log(document.querySelector("#countdownSection").style.display + " countdown");
    countdown = setInterval(updateCountdown, 1000);
    document.getElementById("countdownSection").style.display = "block";
    console.log(document.querySelector("#countdownSection").style.display + " countdown2");
...
function updateCountdown()
{
    ...
    var dateFrom = Date.UTC(dateToday.getFullYear(), dateToday.getMonth(), dateToday.getDate(),
        dateToday.getHours(), dateToday.getMinutes(), dateToday.getSeconds());
...
{
    console.log("createEventsListeners has started");
    ...
    else if (dateCells[0].attachEvent)
    {
        for (var i = 0; i < dateCells.length; i++)
        {
            dateCells.attachEvent("onclick", selectDate);
        }
    }
